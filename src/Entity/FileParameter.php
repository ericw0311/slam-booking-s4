...
/**
 * @ORM\Table(name="file_parameter", uniqueConstraints={@ORM\UniqueConstraint(name="uk_file_parameter",columns={"file_id", "parameter_group", "parameter"})})
...
class FileParameter
{
	...
	public function __construct(\App\Entity\User $user, \App\Entity\File $file, $parameterGroup, $parameter) {
		$this->setUser($user);
		$this->setFile($file);
